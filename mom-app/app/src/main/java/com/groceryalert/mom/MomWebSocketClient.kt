...
object MomWebSocketClient {
    private const val TAG = "MomWS"
    ...
    fun sendAlert(item: String, target: String = "DAD", onResult: (Boolean, String) -> Unit) {
        ...
        client.newWebSocket(request, object : WebSocketListener() {
            ...
            override fun onClosed(webSocket: WebSocket, code: Int, reason: String) {
                // Already handled in onMessage or onFailure
            }
        })
