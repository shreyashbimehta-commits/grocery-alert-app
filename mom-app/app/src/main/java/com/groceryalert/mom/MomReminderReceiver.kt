...
class MomReminderReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (item.isNotEmpty()) {
            val alarmIntent = Intent(context, MomAlarmActivity::class.java).apply {
    ...
    companion object {
        ...
        fun scheduleReminder(context: Context, item: String) {
            ...
            val intent = Intent(context, MomReminderReceiver::class.java)
