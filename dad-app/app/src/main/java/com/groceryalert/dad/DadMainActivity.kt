...
class DadMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dad_main)

        startService(Intent(this, AlarmWebSocketService::class.java))
    ...
    private fun sendAlert() {
        ...
        DadWebSocketClient.sendAlert(item, target) { success, message ->
            runOnUiThread {
                isSending = false
