...
class AlarmWebSocketService : Service() {

    companion object {
        private const val TAG = "AlarmWebSocket"
    ...
    private fun connect() {
        ...
        webSocket = client.newWebSocket(request, object : WebSocketListener() {
            override fun onOpen(webSocket: WebSocket, response: Response) {
                ...
                reconnectAttempt = 0
                val reg = JSONObject().apply { put("role", "DAD") }
    ...
    private fun onWsMessage(text: String) {
        try {
            ...
            if (action == "bought") {
                ...
                val notification = NotificationCompat.Builder(this, DadApplication.ALARM_CHANNEL_ID)
    ...
    private fun buildNotification(text: String): Notification {
        val pendingIntent = PendingIntent.getActivity(
            this, 0,
            Intent(this, DadMainActivity::class.java),
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )
        return NotificationCompat.Builder(this, DadApplication.WS_CHANNEL_ID)
            .setSmallIcon(android.R.drawable.ic_dialog_info)
            .setContentTitle("Grocery Alert Service")
            .setContentText(text)
            .setOngoing(true)
